					...
					<div class="col-sm-12 col-md-12 col-lg-6 col-xs-12 mx-auto my-3">
						<div class="login-form mx-auto">
							...
							<c:if test="${fuser.user_type == 'ADMIN'}">
								<h1 class="text-center mb-0">${fuser.name }AccountDetails</h1>
							</c:if>
										...
										<div class="card-body">
											<div class="row">
                                                ...
                                                <input type="file" name="photo" id="photo" class="form-control-file border-0"> -->
													<label for="file"> <c:if
															test="${fuser.user_type != 'ADMIN'}">
															<input type="file" name="file" id="file"
																style="display: none;" value />
														</c:if> <img
														src="<%= request.getContextPath() %>/uploads/users/${fuser.image}"
												...
												<div class="col-md-12 mb-20">
													<label>Address</label>
													<textarea class="mb-0 border-0 form-control"
														placeholder="Address" name="address">${fuser.address}</textarea>
												</div>
												<div class="col-md-12 mb-20">
