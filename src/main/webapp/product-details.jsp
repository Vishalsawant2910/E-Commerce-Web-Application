							...
							<div class="product-details-images slider-navigation-1">
								<div class="lg-image">
									<a class="popup-img venobox vbox-item"
										href="<%= request.getContextPath() %>/uploads/products/${product.image}"
										data-gall="myGallery"> <img
										src="<%= request.getContextPath() %>/uploads/products/${product.image}"
										alt="product image"> <%-- <img src="${product.image}" alt="product image"> --%>
									</a>
								</div>
							</div>
								...
								<div class="single-add-to-cart">
									...
									<c:if
										...
										<button class="add-to-cart" type="submit"
											style="margin-left: 25px;">Add to cart</button>
									</c:if>

									<c:if test="${fuser.user_type == 'ADMIN'}">
										<button class="add-to-cart" type="submit">Update
											Product</button>
										<a href="remove-product?pid=${product.id}"><button
												class="add-to-cart bg-danger text-white">Remove
												Product</button></a>
									</c:if>
