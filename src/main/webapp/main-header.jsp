			...
			<div class="row">
				...
				<div class="col-lg-3">
					<div class="logo pb-sm-30 pb-xs-30">
						<a href="index.jsp"> <img src="images/menu/logo/quickstore.png" width="200" height="70" alt="">
						</a>
					</div>
				</div>
				...
				<div class="col-lg-9 pl-0 ml-sm-15 ml-xs-15">
					...
					<div class="header-middle-right">
						<ul class="hm-menu">
							...
							<li class="hm-wishlist"><a href="account-details.jsp"> <i
					...
					<div class="hb-menu">
						<nav>
							<ul>
								...
								<li class="dropdown-holder"><a href="index.jsp">Home</a>
